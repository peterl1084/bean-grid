...
public class StringToIntegerBeanConverter extends StringToIntegerConverter implements ConfigurableConverter {
	...
	@Override
	public StringToIntegerBeanConverter configureWithPattern(String pattern) {
